  ...
  useEffect(() => {
      if(id){
          ...
          setPlotData(
            {
              ...singlePlot?.client, 
              plotDetails: singlePlot?.properties?.Plot_Detail, 
              status: singlePlot?.properties?.Plot_Status,
              fullName: singlePlot?.client?.fullName || '',
              email: singlePlot?.client?.email || '',
              country: singlePlot?.client?.country || '',
  ...
  const handleUpdate = (e) => {
    ...
    if(totalAmount === undefined && paidAmount === undefined && remainingAmount === undefined){
      ...
      toast.error('Check the payment amount and the total amount again')
        ...
        if(id){
            dispatch(updatePlot({id, toast, navigate, status, plotDetails, fullName, email, country, phone, address, agent, totalAmount, paidAmount, remainingAmount}))
        }else{
              ...
              <form className="contact-form-wrap contact-form-bg" onSubmit={handleUpdate}>
                  ...
                  <div className="row">
                    <div className="col-md-8">
                      <div className="rld-single-input">
                        ...
                        <input type='text' disabled value={plotDetails} />
                      </div>
                    </div>
                    <div className="col-md-4">
                      <div className="rld-single-input">
                        <label htmlFor="plot-details"> Plot Status</label>
                        <input type='text' disabled value={plotStatus} />
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-12">
                        <div className="form-group">
                            <label className='text-lg mt-3' htmlFor="plot_status">Change Plot Status</label>
                            <select name='status' className="form-control text-dark" onChange={onInputChange} value={status}>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="rld-single-input">
                        <label htmlFor="plot-details"> Full Name</label>
                        <input type='text' onChange={onInputChange} name='fullName' value={fullName} />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="rld-single-input">
                        <label htmlFor="plot-details"> Email Address</label>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="rld-single-input">
                        <label htmlFor="plot-details"> Country</label>
                        <select value={country} onChange={onInputChange} className="form-control text-dark" name="country" id="countryCode">
                    ...
                    <div className="col-md-6">
                      <div className="rld-single-input">
                        <label htmlFor="plot-details"> Phone</label>
                        <input type='number' onChange={onInputChange} name='phone' value={phone} />
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-6">
                      <div className="rld-single-input">
                        <label htmlFor="plot-details"> Address</label>
                        <input type='text' onChange={onInputChange} name='address' value={address} />
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="rld-single-input">
                        <label htmlFor="plot-details"> Agent</label>
                        <input type='text' onChange={onInputChange} name='agent' value={agent} />
                      </div>
                    </div>
                  </div>
